...
import 'package:lestar_user/common/widgets/demo_reset_dialog_widget.dart';
...
import 'package:lestar_user/features/wallet/controllers/wallet_controller.dart';
      ...
      onDidReceiveNotificationResponse: (NotificationResponse response) async {
        try {
          ...
          if (response.payload!.isNotEmpty) {
            payload = NotificationBodyModel.fromJson(
