...
import 'package:lestar_user/features/auth/domain/models/auth_response_model.dart';
import 'package:lestar_user/features/auth/domain/reposotories/auth_repo_interface.dart';
import 'package:lestar_user/features/verification/domein/model/verification_data_model.dart';
import 'package:lestar_user/features/verification/domein/reposotories/verification_repo_interface.dart';
import 'package:lestar_user/features/verification/domein/services/verification_service_interface.dart';
...
class VerificationService implements VerificationServiceInterface {
  ...
  Future<ResponseModel> verifyEmail(
    ...
    Response response = await verificationRepoInterface.verifyEmail(
      email,
      verificationCode,
    );
