...
import 'package:lestar_user/features/auth/widgets/sign_in/existing_user_bottom_sheet.dart';
...
import 'package:lestar_user/features/verification/controllers/verification_controller.dart';
import 'package:lestar_user/features/verification/domein/model/verification_data_model.dart';
                                ...
                                onPressed:
                                    ...
                                    : () {
                                        if (widget.firebaseSession != null &&
                                          ...
                                          verificationController.verifyToken(_number).then((
                                            value,
                                          ) {
                                            if (value.isSuccess) {
