...
import 'package:lestar_user/features/refer%20and%20earn/controllers/refer_and_earn_controller.dart';
import 'package:lestar_user/features/refer%20and%20earn/widgets/bottom_sheet_view_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ExpandableBottomSheet(
        ...
        key: key,
        persistentHeader: !isLoggedIn || ResponsiveHelper.isDesktop(context)
            ? null
            : InkWell(
                onTap: () {
