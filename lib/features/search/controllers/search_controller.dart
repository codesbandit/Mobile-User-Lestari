...
class SearchController extends GetxController implements GetxService {
  ...
  Future<void> searchData1(String query, int offset) async {
    int rating = searchServiceInterface.findRatings(
      _isRestaurant ? _restaurantRating : _rating,
    );
    bool isNewActive = _isRestaurant
        ? _isNewArrivalsRestaurant
        : _isNewArrivalsFoods;
