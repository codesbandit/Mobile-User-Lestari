...
import 'package:lestar_user/common/widgets/search_field_widget.dart';
...
import 'package:lestar_user/features/home/widgets/cuisine_card_widget.dart';
import 'package:lestar_user/features/search/controllers/search_controller.dart'
    as search;
import 'package:lestar_user/features/search/widgets/filter_widget.dart';
import 'package:lestar_user/features/search/widgets/search_result_widget.dart';
...
class SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _searchSuggestions(String query) async {
    ...
    if (query == '') {
      ...
      _foodsAndRestaurants = await Get.find<search.SearchController>()
                                          ...
                                          _isLoggedIn
                                              ? searchController
                                                    ...
                                                    ? searchController
                                                              ...
                                                              .isNotEmpty
                                                          ? Wrap(
                                                              children: searchController.suggestedFoodList!.map((
                                                                product,
                                                              ) {
                                                                return Padding(
  ...
  void _actionSearch(
    ...
    if (searchController.isSearchMode || isSubmit) {
      ...
      double? maxValue = searchController.upperValue > 0
