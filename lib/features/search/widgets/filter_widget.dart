...
import 'package:lestar_user/features/search/controllers/search_controller.dart'
    as search;
import 'package:lestar_user/features/search/widgets/custom_check_box_widget.dart';
    ...
    return Container(
      ...
      child: GetBuilder<search.SearchController>(
        builder: (searchController) {
          List<String> sortListData = widget.isRestaurant
              ? searchController.restaurantSortList
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: sortListData.map((sort) {
                          ...
                          bool isSelected = widget.isRestaurant
                              ? (index == searchController.restaurantSortIndex)
                              : (index == searchController.sortIndex);
                          return Padding(
                      ...
                      CustomCheckBoxWidget(
                        ...
                        value: widget.isRestaurant
                            ? searchController.isNewArrivalsRestaurant
                            : searchController.isNewArrivalsFoods,
                        onClick: () {
                          if (widget.isRestaurant) {
                      ...
                      CustomCheckBoxWidget(
                        title: 'popular'.tr,
                        value: widget.isRestaurant
                            ? searchController.isPopularRestaurant
                            : searchController.isPopularFood,
                        onClick: () {
                          if (widget.isRestaurant) {
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            if (widget.isRestaurant) {
                              ...
                              isSelected =
                                  searchController.rating == (5 - index);
                            }
                            ...
                            return Padding(
                              ...
                              child: CustomCheckBoxWidget(
                                ...
                                onClick: () {
                                  if (widget.isRestaurant) {
                                    searchController.setRestaurantRating(
                                      5 - index,
                                    );
                                  } else {
                                    ...
                                    ? Column(
                                        ...
                                        children: [
                                          ...
                                          ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            itemBuilder: (context, index) {
                                              bool isSelected = searchController
                                                  .selectedCuisines
                                                  .contains(
                                                    cuisineController
                                                        .cuisineModel!
