...
import 'package:lestar_user/features/search/controllers/search_controller.dart'
    as search;
import 'package:lestar_user/features/search/widgets/item_view_widget.dart';
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: TabBar(
                  ...
                  onTap: (int index) {
                    Get.find<search.SearchController>().setRestaurant(
                      index == 1,
                    );
                    Get.find<search.SearchController>().searchData1(
                      widget.searchText,
                      1,
                    );
                  },
