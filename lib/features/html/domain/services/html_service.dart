import 'package:lestar_user/features/html/domain/repositories/html_repository_interface.dart';
import 'package:lestar_user/features/html/domain/services/html_service_interface.dart';
...
class HtmlService implements HtmlServiceInterface {
  ...
  Future<String?> getHtmlText(HtmlType htmlType, String languageCode) async {
    String? htmlText;
    Response response = await htmlRepositoryInterface.getHtmlText(
      htmlType,
      languageCode,
    );
