...
import 'package:lestar_user/features/restaurant/domain/models/cart_suggested_item_model.dart';
import 'package:lestar_user/features/restaurant/domain/models/recommended_product_model.dart';
import 'package:lestar_user/common/models/restaurant_model.dart';
import 'package:lestar_user/features/category/domain/models/category_model.dart';
import 'package:lestar_user/features/restaurant/domain/services/restaurant_service_interface.dart';
...
class RestaurantController extends GetxController implements GetxService {
  ...
  double getRestaurantDistance(LatLng restaurantLatLng) {
    return restaurantServiceInterface.getRestaurantDistanceFromUser(
      restaurantLatLng,
    );
  }
  ...
  Future<void> getOrderAgainRestaurantList(
    bool reload, {
    ...
    if (searchText.isEmpty) {
      ...
      if (productModel != null) {
        if (offset == 1) {
          ...
          _restaurantSearchProductModel!.products!.addAll(
