...
import 'package:lestar_user/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
...
class RestaurantService implements RestaurantServiceInterface {
  ...
  @override
  Future<List<Restaurant>?> getRecentlyViewedRestaurantList(
    String type, {
    DataSourceEnum? source,
  }) async {
    return await restaurantRepositoryInterface.getRestaurantList(
  ...
  @override
  Future<List<Restaurant>?> getPopularRestaurantList(
    String type, {
    DataSourceEnum? source,
  }) async {
    return await restaurantRepositoryInterface.getRestaurantList(
  ...
  @override
  Future<List<Restaurant>?> getLatestRestaurantList(
    String type, {
    DataSourceEnum? source,
  }) async {
    return await restaurantRepositoryInterface.getRestaurantList(
  ...
  Future<RecommendedProductModel?> getRestaurantRecommendedItemList(
    ...
    return await restaurantRepositoryInterface.getRestaurantRecommendedItemList(
      restaurantId,
    );
  }
  ...
  Future<Restaurant?> getRestaurantDetails(
    ...
    return await restaurantRepositoryInterface.get(
      restaurantID,
      slug: slug,
  ...
  @override
  AddressModel prepareAddressModel(
