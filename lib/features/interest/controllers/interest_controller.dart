...
import 'package:lestar_user/features/interest/domain/services/interest_service_interface.dart';
...
class InterestController extends GetxController implements GetxService {
  ...
  Future<void> getCategoryList(bool reload) async {
    ...
    _interestCategorySelectedList = interestServiceInterface
        .processCategorySelectedList(_categoryList);
  ...
  Future<bool> saveInterest(List<int?> interests) async {
    _isLoading = true;
    update();
    bool isSuccess = await interestServiceInterface.saveUserInterests(
      interests,
    );
    _isLoading = false;
    update();
