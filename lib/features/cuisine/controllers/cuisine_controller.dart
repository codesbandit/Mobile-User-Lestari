...
import 'package:lestar_user/features/cuisine/domain/services/cuisine_service_interface.dart';
...
class CuisineController extends GetxController implements GetxService {
  ...
  Future<void> getCuisineList({
    ...
    if (dataSource == DataSourceEnum.local) {
      cuisineModel = await cuisineServiceInterface.getCuisineList(
  ...
  Future<void> getCuisineRestaurantList(
    ...
    CuisineRestaurantModel? restaurantModel = await cuisineServiceInterface
        .getRestaurantList(offset, cuisineId);
