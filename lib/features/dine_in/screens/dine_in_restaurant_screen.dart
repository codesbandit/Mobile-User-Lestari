...
import 'package:lestar_user/common/widgets/custom_bottom_sheet_widget.dart';
import 'package:lestar_user/common/widgets/custom_distance_cliper_widget.dart';
import 'package:lestar_user/common/widgets/custom_favourite_widget.dart';
import 'package:lestar_user/common/widgets/custom_image_widget.dart';
import 'package:lestar_user/common/widgets/custom_ink_well_widget.dart';
...
import 'package:lestar_user/features/dine_in/widgets/dine_in_restaurant_filter_bottom_sheet.dart';
import 'package:lestar_user/features/dine_in/widgets/dine_in_restaurant_shimmer_widget.dart';
                      ...
                      return dineInController.dineInModel != null
                          ? dineInController
                                ...
                                ? PaginatedListViewWidget(
                                    ...
                                    offset:
                                        dineInController.dineInModel!.offset,
                                    onPaginate: (int? offset) async =>
                                        await dineInController
                                            .getDineInRestaurantList(
                                              offset!,
                                              false,
                                            ),
                      ...
                      Positioned(
                        ...
                        child: ClipPath(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                '${Get.find<RestaurantController>().getRestaurantDistance(LatLng(double.parse(restaurant.latitude!), double.parse(restaurant.longitude!))).toStringAsFixed(2)} ${'km'.tr}',
                                style: robotoMedium.copyWith(
