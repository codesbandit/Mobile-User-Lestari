...
import 'package:lestar_user/features/dine_in/domain/repositories/dine_in_repository_interface.dart';
import 'package:lestar_user/features/dine_in/domain/services/dine_in_service_interface.dart';
...
class DineInService implements DineInServiceInterface {
  ...
  @override
  Future<DineInModel?> getDineInRestaurantList({
    int? offset,
    ...
    return await dineInRepositoryInterface.getRestaurantList(
      offset: 1,
