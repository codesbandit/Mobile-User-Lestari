...
import 'package:lestar_user/features/home/widgets/google_map_widgets/restaurant_search_widget.dart';
import 'package:lestar_user/features/home/widgets/map_custom_info_window_widget.dart';
import 'package:lestar_user/features/home/widgets/google_map_widgets/restaurant_details_sheet_widget.dart';
import 'package:lestar_user/features/home/widgets/restaurants_view_widget.dart';
import 'package:lestar_user/features/location/controllers/location_controller.dart';
import 'package:lestar_user/features/location/widgets/permission_dialog.dart';
...
import 'package:lestar_user/features/splash/controllers/theme_controller.dart';
...
class _MapViewScreenState extends State<MapViewScreen> {
  ...
  void initState() {
    ...
    Get.find<RestaurantController>().setNearestRestaurantIndex(
      -1,
      notify: false,
    );
  ...
  _animateMarker(Restaurant restaurant, int index) async {
    ...
    ResponsiveHelper.isWeb()
        ...
        : _customInfoWindowController.addInfoWindow!(
            MapCustomInfoWindowWidget(restaurant: restaurant),
            latLng,
          );
  ...
  void _setMarkers(
    ...
    try {
      ...
      final Uint8List myLocationMarkerIcon = await _convertAssetToUnit8List(
      ...
      for (int index = 0; index < restaurants.length; index++) {
        index0++;
        LatLng latLng = LatLng(
          double.parse(restaurants[index].latitude!),
