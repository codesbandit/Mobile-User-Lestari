            ...
            children: [
              ...
              Row(
                ...
                Text(isAvailable ? 'open_now'.tr : 'closed_now'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault,
                  ...
                  //const Spacer(),
                  Text(
                    '${(Geolocator.distanceBetween(double.parse(restaurant.latitude!), double.parse(restaurant.longitude!), double.parse(AddressHelper.getAddressFromSharedPref()!.latitude!), double.parse(AddressHelper.getAddressFromSharedPref()!.longitude!)) / 1000).toStringAsFixed(1)} ${'km'.tr}',
                    style: robotoBold.copyWith(
                      fontSize: Dimensions.fontSizeLarge,
                    ),
                  ),
