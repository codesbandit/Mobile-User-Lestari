                      ...
                      Padding(
                        ...
                        child: PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            bool hasFirst =
                                index1 < homeController.bannerImageList!.length;
                            bool hasSecond =
                                index2 < homeController.bannerImageList!.length;
                            bool hasThird =
                                index3 < homeController.bannerImageList!.length;
              ...
              ? Builder(
                  builder: (context) {
                    ...
                    for (
                      ...
                      if (i % 3 == 0) {
                        finalBanner.add(
                          homeController.bannerImageList![i] ?? '',
                        );
                      }
                    }
