...
import 'package:lestar_user/features/product/domain/services/product_service_interface.dart';
...
class ProductController extends GetxController implements GetxService {
  ...
  void initData(Product? product, CartModel? cart) {
    ...
    if (cart != null) {
      ...
      _collapseVariation = productServiceInterface.initializeCollapseVariation(
        product.variations,
      );
    } else {
      _quantity = 1;
      _selectedVariations = productServiceInterface.initializeSelectedVariation(
        product!.variations,
      );
      _variationsStock = productServiceInterface.initializeVariationsStock(
        product.variations,
      ...
      _addOnActiveList = productServiceInterface.initializeAddonActiveList(
        product.addOns,
      );
      _addOnQtyList = productServiceInterface.initializeAddonQuantityList(
        product.addOns,
      );
    }
