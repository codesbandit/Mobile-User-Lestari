...
import 'package:lestar_user/features/dashboard/domain/services/dashboard_service_interface.dart';
...
class DashboardController extends GetxController implements GetxService {
  ...
  Future<bool> checkLocationActive() async {
    ...
    if (isActiveLocation) {
      AddressModel currentAddress = await Get.find<LocationController>()
