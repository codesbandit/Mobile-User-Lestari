...
import 'package:lestar_user/common/widgets/cart_widget.dart';
import 'package:lestar_user/common/widgets/custom_dialog_widget.dart';
...
import 'package:lestar_user/features/checkout/widgets/congratulation_dialogue.dart';
import 'package:lestar_user/features/dashboard/controllers/dashboard_controller.dart';
import 'package:lestar_user/features/dashboard/widgets/address_bottom_sheet.dart';
import 'package:lestar_user/features/dashboard/widgets/bottom_nav_item.dart';
import 'package:lestar_user/features/dashboard/widgets/registration_success_bottom_sheet.dart';
import 'package:lestar_user/features/dashboard/widgets/running_order_view_widget.dart';
...
import 'package:lestar_user/features/menu/screens/menu_screen.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  _showRegistrationSuccessBottomSheet() {
    bool canShowBottomSheet = Get.find<DashboardController>()
        .getRegistrationSuccessfulSharedPref();
    if (canShowBottomSheet) {
      Future.delayed(const Duration(seconds: 1), () {
        ResponsiveHelper.isDesktop(Get.context)
            ? Get.dialog(
                const Dialog(child: RegistrationSuccessBottomSheet()),
              ).then((value) {
