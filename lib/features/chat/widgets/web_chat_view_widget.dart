...
import 'package:lestar_user/common/widgets/web_search_field_widget.dart';
...
import 'package:lestar_user/features/chat/controllers/chat_controller.dart';
import 'package:lestar_user/features/chat/domain/models/conversation_model.dart';
import 'package:lestar_user/features/chat/widgets/chatting_shimmer_widget.dart';
import 'package:lestar_user/features/chat/widgets/message_bubble_widget.dart';
import 'package:lestar_user/features/chat/widgets/web_conversation_list_view_widget.dart';
import 'package:lestar_user/common/enums/user_type.dart';
                                                            ...
                                                            productView: ListView.builder(
                                                              ...
                                                              itemBuilder: (context, index) {
                                                                return MessageBubbleWidget(
                                                                  ...
                                                                  nextMessage:
                                                                      index ==
                                                                          (widget.chatController.messageModel!.messages!.length -
                                                                              1)
                                                                      ? null
                                                                      : widget
                                                                            .chatController
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child: Column(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              chatController.pickedWebVideoFile!.files.first.name,
                                                                              maxLines: 2,
