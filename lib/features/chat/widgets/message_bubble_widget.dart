...
import 'package:lestar_user/features/chat/widgets/image_file_view_widget.dart';
import 'package:lestar_user/features/chat/widgets/pdf_view_widget.dart';
...
import 'package:lestar_user/features/chat/domain/models/message_model.dart';
import 'package:lestar_user/common/enums/user_type.dart';
import 'package:lestar_user/helper/responsive_helper.dart';
import 'package:lestar_user/util/color_resources.dart';
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    color: isRightMessage
                                        ? ColorResources.getRightBubbleColor()
                                        : ColorResources.getLeftBubbleColor(),
                            ...
                            Row(
                              ...
                              children: [
                                AnimatedContainer(
                                  ...
                                  height:
                                      chatController.onMessageTimeShowID ==
                                          currentMessage.id
                                      ? 25.0
                                      : 0.0,
                                  child: Padding(
                                ...
                                ? Column(
                                    ...
                                    children: [
                                      currentMessage.filesFullUrl!.isNotEmpty
                                          ? Directionality(
                                              textDirection:
                                                  isRightMessage && isLTR
                                                  ? TextDirection.rtl
                                                  : !isLTR && !isRightMessage
                                                  ? TextDirection.rtl
                                                  : TextDirection.ltr,
                                              child: SizedBox(
                                                width:
