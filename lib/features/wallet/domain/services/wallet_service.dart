...
import 'package:lestar_user/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:lestar_user/features/wallet/domain/services/wallet_service_interface.dart';
...
class WalletService implements WalletServiceInterface {
  ...
  Future<void> addFundToWallet(double amount, String paymentMethod) async {
    Response response = await walletRepositoryInterface.addFundToWallet(
      amount,
      paymentMethod,
    );
