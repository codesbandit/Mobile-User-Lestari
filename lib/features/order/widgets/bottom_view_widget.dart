...
import 'package:lestar_user/features/order/widgets/cancellation_dialogue.dart';
import 'package:lestar_user/features/order/widgets/subscription_pause_dialog.dart';
                  ...
                  ? Get.find<AuthController>().isLoggedIn()
                        ? Row(
                            children: [
                              ...
                              SizedBox(
                                width:
                                    cancelled || order.orderStatus == 'failed'
                                    ? 0
                                    : Dimensions.paddingSizeSmall,
                              ),
