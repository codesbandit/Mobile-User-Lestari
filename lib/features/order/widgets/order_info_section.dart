...
import 'package:lestar_user/common/widgets/rating_bar_widget.dart';
...
import 'package:lestar_user/features/order/widgets/log_bottom_sheet_widget.dart';
import 'package:lestar_user/features/order/widgets/offline_info_edit_dialog.dart';
...
import 'package:lestar_user/features/order/widgets/delivery_details.dart';
import 'package:lestar_user/features/order/widgets/order_product_widget.dart';
import 'package:lestar_user/features/review/widgets/review_dialog_widget.dart';
...
import 'package:lestar_user/features/chat/widgets/image_dialog_widget.dart';
...
class OrderInfoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool ongoing =
        ((isDineIn ? true : order.orderStatus != 'delivered') &&
    ...
    bool pastOrder =
        ((isDineIn ? false : order.orderStatus == 'delivered') ||
        order.orderStatus == 'failed' ||
        order.orderStatus == 'refund_requested' ||
        order.orderStatus == 'refunded' ||
        order.orderStatus == 'refund_request_canceled' ||
      ...
      children: [
                                                  ...
                                                  ? RichText(
                                                      ...
                                                      text: TextSpan(
                                                        children: [
                                                          ...
                                                          TextSpan(
                                                            text: DateConverter.dateTimeStringToDateTime(
                                                              order.scheduleAt!,
                                                            ),
                                                            style: robotoMedium.copyWith(
                                                              fontSize: Dimensions
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    DateConverter.differenceInMinute(
                                                                            ...
                                                                            5
                                                                        ? '1 - 5 ${'min'.tr}'
                                                                        : DateConverter.convertMinutesToDayHourMinute(
                                                                            DateConverter.differenceInMinute(
                                                                              null,
                                                                              order.createdAt,
                                                                              null,
        ...
        Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () => Get.toNamed(
                RouteHelper.getRestaurantRoute(order.restaurant?.id),
              ),
              child: Container(
                decoration: BoxDecoration(
                  color: Theme.of(context).cardColor,
