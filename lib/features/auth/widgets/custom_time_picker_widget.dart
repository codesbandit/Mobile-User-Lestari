...
import 'package:lestar_user/features/auth/widgets/min_max_time_picker_widget.dart';
                  ...
                  children: [
                    ...
                    CustomButtonWidget(
                      ...
                      onPressed: () {
                        ...
                        try {
                          min = int.parse(
                            restaurantRegiController.storeMinTime,
                          );
                          max = int.parse(
                            restaurantRegiController.storeMaxTime,
                          );
                          isValid = true;
                        } catch (e) {
                          log(3);
