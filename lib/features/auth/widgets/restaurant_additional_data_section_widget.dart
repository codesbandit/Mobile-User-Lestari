    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          bool showTextField =
              restaurantRegiController.dataList![index].fieldType == 'text' ||
                                  ...
                                  if (file != null) {
                                    if (!GetPlatform.isWeb) {
                                      fileName = file.files.single.path!
                                          ...
                                          .last;
                                      isImage =
                                          file.files.single.path!.contains(
                                            'jpg',
                                          ) ||
                                          file.files.single.path!.contains(
                                            'jpeg',
                                      ...
                                      fileName = file.files.first.name;
                                      isImage =
                                          file.files.first.name.contains(
                                            'jpg',
                                          ) ||
                                          file.files.first.name.contains(
                                            'jpeg',
