...
import 'package:lestar_user/features/auth/domain/services/deliveryman_registration_service_interface.dart';
...
class DeliverymanRegistrationController extends GetxController
  ...
  void pickDmImage(bool isImage, bool isRemove) async {
    if (isRemove) {
      ...
      if (isImage) {
        _pickedImage = await deliverymanRegistrationServiceInterface
            .picImageFromGallery();
      } else {
        XFile? xFile = await deliverymanRegistrationServiceInterface
            .picImageFromGallery();
        if (xFile != null) {
  ...
  Future<void> getVehicleList() async {
    ...
    _vehicleIds = deliverymanRegistrationServiceInterface.setVehicleIdList(
      _vehicles,
    );
    update();
  }
  ...
  Future<void> pickFile(int index, MediaData mediaData) async {
    FilePickerResult? result = await deliverymanRegistrationServiceInterface
        .picFile(mediaData);
    if (result != null) {
