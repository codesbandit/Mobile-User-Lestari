...
import 'package:lestar_user/common/widgets/confirmation_dialog_widget.dart';
...
import 'package:lestar_user/common/widgets/custom_text_field_widget.dart';
import 'package:lestar_user/common/widgets/custom_tool_tip.dart';
...
import 'package:lestar_user/common/widgets/validate_check.dart';
import 'package:lestar_user/common/widgets/web_page_title_widget.dart';
import 'package:lestar_user/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:lestar_user/features/auth/controllers/restaurant_registration_controller.dart';
import 'package:lestar_user/features/auth/domain/models/restaurant_body_model.dart';
import 'package:lestar_user/features/auth/domain/models/translation_body_model.dart';
import 'package:lestar_user/features/auth/widgets/cuisine_widget.dart';
import 'package:lestar_user/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:lestar_user/features/auth/widgets/pass_view_widget.dart';
import 'package:lestar_user/features/auth/widgets/registration_stepper_widget.dart';
import 'package:lestar_user/features/auth/widgets/restaurant_additional_data_section_widget.dart';
import 'package:lestar_user/features/auth/widgets/select_location_view_widget.dart';
import 'package:lestar_user/features/business/widgets/base_card_widget.dart';
import 'package:lestar_user/features/business/widgets/package_card_widget.dart';
import 'package:lestar_user/features/business/widgets/web_business_plan_widget.dart';
...
class _RestaurantRegistrationScreenState
  ...
  void initState() {
    ...
    Get.find<RestaurantRegistrationController>().storeStatusChange(
      0.1,
      isUpdate: false,
    );
    ...
    Get.find<RestaurantRegistrationController>().getPackageList(
      isUpdate: false,
    );
    ...
    return GetBuilder<RestaurantRegistrationController>(
      builder: (restaurantRegController) {
        if (restaurantRegController.restaurantAddress != null) {
          _addressController[0].text = restaurantRegController.restaurantAddress
              .toString();
        }
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child: ClipRRect(
                                                                        ...
                                                                        child:
                                                                            restaurantRegController.pickedLogo !=
                                                                                null
                                                                            ? GetPlatform.isWeb
                                                                                  ? Image.network(
                                                              ...
                                                              child:
                                                                  ...
                                                                  ? Swiper(
                                                                      ...
                                                                      onIndexChanged: (index) {
                                                                        restaurantRegController.selectSubscriptionCard(
                                                                          index,
                                                                        );
                                                                      },
                                                                    )
        ...
        return Column(
          children: [
            CustomButtonWidget(
              ...
              buttonText:
                  restaurantRegiController.storeStatus == 0.1 &&
                      !ResponsiveHelper.isDesktop(context)
                  ? 'next'.tr
                  : 'submit'.tr,
              onPressed:
                  ...
                  : () {
                      ...
                      if (restaurantRegiController.storeStatus != 0.1 ||
                        ...
                        for (DataModel data
                          ...
                          int index = restaurantRegiController.dataList!
                              .indexOf(data);
                        ...
                        data.addAll(
                          RestaurantBodyModel(
                            ...
                            zoneId: restaurantRegiController
                                .zoneList![restaurantRegiController
                                    .selectedZoneIndex!]
                                .id
                                .toString(),
                            cuisineId: cuisines,
