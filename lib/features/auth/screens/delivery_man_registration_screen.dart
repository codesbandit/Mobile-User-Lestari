...
import 'package:lestar_user/features/auth/domain/models/delivery_man_body_model.dart';
import 'package:lestar_user/features/auth/widgets/trams_conditions_check_box_widget.dart';
...
import 'package:lestar_user/features/auth/domain/models/vehicle_model.dart';
import 'package:lestar_user/features/auth/domain/models/zone_model.dart';
import 'package:lestar_user/features/auth/screens/web/deliveryman_registration_web_screen.dart';
import 'package:lestar_user/features/auth/widgets/deliveryman_additional_data_section_widget.dart';
import 'package:lestar_user/features/auth/widgets/pass_view_widget.dart';
import 'package:lestar_user/helper/custom_validator.dart';
...
import 'package:lestar_user/common/widgets/custom_dropdown_widget.dart';
...
class _DeliveryManRegistrationScreenState
  ...
  void initState() {
    ...
    Get.find<DeliverymanRegistrationController>().validPassCheck(
      '',
      isUpdate: false,
    );
        ...
        body: SafeArea(
          child: GetBuilder<DeliverymanRegistrationController>(
            builder: (deliverymanController) {
              List<int> zoneIndexList = _generateZoneIndexList(
                deliverymanController.zoneList,
              );
              ...
              List<DropdownItem<int>> dmTypeList = _generateDropDownDmTypeList(
                deliverymanController.dmTypeList,
              );
                                                                  ...
                                                                  child: CustomDropdown<int>(
                                                                    onChange:
                                                                        (
                                                                          ...
                                                                          deliverymanController.setZoneIndex(
                                                                            value,
                                                                          );
                                                                        },
                                                                    indexZeroNotSelected:
                                                                  ...
                                                                  child: Stack(
                                                                    children: [
                                                                      ...
                                                                      Positioned(
                                                                        ...
                                                                        top: 10,
                                                                        child: InkWell(
                                                                          onTap: () => deliverymanController.removeIdentityImage(
                                                                            index,
                                                                          ),
                                                                          child: Container(
                                                                            decoration: BoxDecoration(
      ...
      builder: (deliverymanController) {
        return Container(
          ...
          child: CustomButtonWidget(
            ...
            buttonText:
                (deliverymanController.dmStatus == 0.1 &&
                    !ResponsiveHelper.isDesktop(context))
                ? 'next'.tr
                : 'submit'.tr,
  ...
  void _addDeliveryMan(
        ...
        if (isTextField) {
          ...
          if (deliverymanController.additionalList![index].text != '') {
            additionalData.addAll({
              data.inputData!:
                  deliverymanController.additionalList![index].text,
            });
          } else {
            if (isRequired) {
    ...
    if (deliverymanController.dmTypeIndex == 0) {
      ...
      data.addAll(
        DeliveryManBodyModel(
          ...
          zoneId: deliverymanController
              .zoneList![deliverymanController.selectedZoneIndex!]
              .id
              .toString(),
      ...
      data.addAll({'additional_data': jsonEncode(additionalData)});
