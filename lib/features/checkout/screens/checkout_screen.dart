...
import 'package:lestar_user/common/widgets/not_logged_in_screen.dart';
...
import 'package:lestar_user/features/checkout/widgets/bottom_section_widget.dart';
import 'package:lestar_user/features/checkout/widgets/checkout_screen_shimmer_view.dart';
import 'package:lestar_user/features/checkout/widgets/order_place_button.dart';
import 'package:lestar_user/features/checkout/widgets/top_section_widget.dart';
...
import 'package:lestar_user/features/location/domain/models/zone_response_model.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
                    ...
                    ? GetBuilder<LocationController>(
                        builder: (locationController) {
                          ...
                          if (checkoutController.restaurant != null) {
                            ...
                            tomorrowClosed = checkoutController
                                .isRestaurantClosed(
                          ...
                          return GetBuilder<CouponController>(
                            builder: (couponController) {
                              ...
                              if (checkoutController.restaurant != null &&
                                ...
                                if (checkoutController.orderType !=
                                        'take_away' &&
      ...
      if (checkoutController.subscriptionOrder &&
        ...
        if (checkoutController.subscriptionType == 'weekly') {
          ...
          subscriptionQty = DateConverter.getWeekDaysCount(
            checkoutController.subscriptionRange!,
            weekDays,
          );
  ...
  double _calculateExtraPackagingCharge(CheckoutController checkoutController) {
    if (((checkoutController.restaurant != null &&
                ...
                !checkoutController
                    .restaurant!
                    .extraPackagingStatusIsMandatory! &&
