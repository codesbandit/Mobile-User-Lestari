...
import 'package:lestar_user/features/checkout/domain/models/date_month_body_model.dart';
import 'package:lestar_user/features/checkout/widgets/slot_widget.dart';
...
class _TimeSlotBottomSheetState extends State<TimeSlotBottomSheet> {
  ...
  Future<void> initializeTimeSlots(bool willDelay) async {
    ...
    if (selectedDateSlotIndex == 0) {
      Get.find<CheckoutController>().updateDateSlot(
        DateTime.now(),
        _instanceOrder,
      );
