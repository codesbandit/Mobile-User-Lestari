...
import 'package:lestar_user/features/checkout/widgets/offline_payment_button.dart';
import 'package:lestar_user/features/checkout/widgets/paylabs_payment_methods_widget.dart';
...
class _PaymentMethodBottomSheet2State extends State<PaymentMethodBottomSheet2> {
  ...
  void initState() {
    ...
    if (Get.find<CheckoutController>().exchangeAmount > 0) {
      ...
      _amountController.text = Get.find<CheckoutController>().exchangeAmount
          .toString();
    }

    configurePartialPayment();

    if (Get.find<CheckoutController>().paylabsPaymentMethods == null) {
      Get.find<CheckoutController>().fetchPaylabsPaymentMethods();
    }
  }
                                      ...
                                      children: [
                                        ...
                                        if (checkoutController
                                          ...
                                          Padding(
                                            ...
                                            child: PaylabsPaymentMethodsWidget(
                                              disablePayments: disablePayments,
                                            ),
                                          )
                                        else
