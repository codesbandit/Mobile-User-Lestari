...
import 'package:lestar_user/features/checkout/widgets/delivery_info_fields.dart';
                  ...
                  children: [
                          ...
                          if (value == -1) {
                            ...
                            if (address != null) {
                              ...
                              checkoutController.getDistanceInKM(
                                ...
                                LatLng(
                                  double.parse(
                                    checkoutController.restaurant!.latitude!,
                                  ),
                                  double.parse(
                                    checkoutController.restaurant!.longitude!,
                                  ),
                                ),
                              );
                            }
                            ...
                            checkoutController.getDistanceInKM(
                              LatLng(
                                double.parse(
                                  checkoutController.address[value!].latitude!,
                                ),
                                double.parse(
                                  checkoutController.address[value].longitude!,
                                ),
                              ),
                              LatLng(
                                double.parse(
                    ...
                    Container(
                      ...
                      child: AddressCardWidget(
                        address:
                            (checkoutController.address.length - 1) >=
                                checkoutController.addressIndex
                            ? checkoutController.address[checkoutController
                                  .addressIndex]
